...
sealed class MaterialDesign3TextItem(var route: String){
    object Heading : MaterialDesign3TextItem("Heading")
    object NormalText : MaterialDesign3TextItem("NormalText")
    object InputText : MaterialDesign3TextItem("InputText")
    object ButtonText: MaterialDesign3TextItem("ButtonText")
}
